...
Kit version: `2026.7.27` · 20 agents · 82 skills · 13 workflows
...
flowchart LR
  ...
  subgraph Skills
    ...
    S_brand_architecture["brand-architecture"]
    S_brand_audit["brand-audit"]
    S_brand_context["brand-context"]
    S_brand_extractor["brand-extractor"]
    S_brand_guidelines["brand-guidelines"]
    S_brand_identity["brand-identity"]
    S_brand_identity_extractor["brand-identity-extractor"]
    S_brand_init["brand-init"]
    S_brand_messaging["brand-messaging"]
    S_brand_positioning["brand-positioning"]
    S_brand_story["brand-story"]
    S_brand_strategy["brand-strategy"]
    S_brand_voice["brand-voice"]
    S_competitor_branding["competitor-branding"]
    S_naming["naming"]
    S_rebranding["rebranding"]
    S_target_audience["target-audience"]
    S_canvas_design["canvas-design"]
    ...
    S_3d_games["3d-games"]
    S_game_art["game-art"]
    S_game_audio["game-audio"]
    S_game_design["game-design"]
    S_mobile_games["mobile-games"]
    S_multiplayer["multiplayer"]
    S_pc_games["pc-games"]
    S_game_development["game-development"]
    S_vr_ar["vr-ar"]
    S_web_games["web-games"]
    S_geo_fundamentals["geo-fundamentals"]
    S_hostinger_deploy["hostinger-deploy"]
    ...
    S_ui_design_system["ui-design-system"]
    S_ui_ux_pro_max["ui-ux-pro-max"]
