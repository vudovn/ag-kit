#!/usr/bin/env python3
"""
🌙📥 LUNA OS — FULL CONVERSATION EXTRACTION
Extrai TODAS as conversas individuais (excluindo grupos)
"""
...
# Load previously extracted messages
...
with open(txt_file, 'w', encoding='utf-8') as f:
    f.write("=" * 80 + "\n")
    f.write("LUNA OS — TOP CONVERSAS DO WHATSAPP (INDIVIDUAIS)\n")
