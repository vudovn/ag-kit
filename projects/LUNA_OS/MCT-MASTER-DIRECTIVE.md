# 📜 MCT MASTER DIRECTIVE — LUNA_OS

> [!IMPORTANT]
> Este arquivo é a fonte mestre de contexto. Leia-o integralmente antes de codificar.

## 🎯 Project Charter (Leis e Objetivo)
...
## 📂 Codebase State
(Codebase não encontrado)

## 🧠 Brain References
[Use 'mct-brain' para buscar playbooks técnicos adicionais se necessário]
